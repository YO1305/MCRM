...
export function KpiExplanation({ role }: { role: KpiPayrollRole }) {
  ...
  return (
    <Card className="space-y-4 bg-slate-50/80">
      ...
      <p className="text-xs leading-relaxed text-muted">
        Лид в блок 2 попадает, если за месяц в Истории есть работа менеджера с клиентом и набрано
        минимум шагов (КП, звонок, образцы, этап, комментарий). Сделка в 1-м месяце — сразу. С 4-го
        месяца лид в KPI не идёт. Фразы от клиента не нужны.
      </p>
    </Card>
  )
}
