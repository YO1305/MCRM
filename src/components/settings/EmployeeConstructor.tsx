    ...
    >
      <div className="flex items-start gap-2">
        ...
        <div>
          ...
          <p className="mt-1 text-xs text-muted">
            Отпуск, больничный и т.п. В выбранные дни CRM не создаёт сотруднику ежедневные и
            по расписанию задачи. Если пауза включает сегодня — открытые задачи по шаблонам
            сразу уберутся.
          </p>
        </div>
      </div>
