      ...
      <Card className="space-y-3">
        <div className="flex flex-wrap items-start justify-between gap-2">
          <div>
            ...
            <p className="text-xs text-muted">
              Почему засчитан: шаги в Истории + категории (ткань / ГП / Европа). Excel для
              начальника: клиент, компания, этап и живой комментарий, что сделали по лиду — без
              ленты истории и без «3 шага / 2 дня».
            </p>
          </div>
          <Button
            type="button"
