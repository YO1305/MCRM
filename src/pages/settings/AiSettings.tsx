        ...
        <Card className="space-y-4">
          ...
          <div className="flex flex-wrap gap-2">
            ...
            <p className="w-full text-xs text-muted">
              После сброса нажмите «Сохранить промпт». К каждому запросу система всё равно
              добавляет жёсткие правила: не дублировать запланированный шаг и не писать так,
              будто запрос клиента уже выполнен.
            </p>
          </div>
